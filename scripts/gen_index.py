...
def generate_index() -> str:
    ...
    if not items:
        items = '<li class="item"><p class="item-desc">暂无 HTML 页面。</p></li>'
...
<head>
  ...
  <meta name="description" content="研究 HTML 页面归档索引">
  <title>研究页面归档</title>
  <style>
...
<body>
  <main class="container">
    <h1>研究页面归档 <span class="count">{count} 个页面</span></h1>
    <p class="subtitle">自动生成的索引页 · 更新时间：{updated}</p>
    <ul>{items}
    </ul>
    <p class="footer">由 scripts/gen_index.py 自动生成</p>
  </main>
</body>
</html>
"""
